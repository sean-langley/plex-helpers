...
RES="1080"        # Resolution to convert to:
...
VIDEO_QUALITY=21 #Lower values produce better quality. It is not recommended going lower than 18. 26 produces around 1Mbps video, 23 around 1.5Mbps.
